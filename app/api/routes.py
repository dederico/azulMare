...
from app.services.functions.implementations.discount import get_customer_discount
from app.services.functions.implementations.debt import get_customer_debt
import os
...
async def websocket_endpoint(ws: WebSocket):
    ...
    # Set up Speech-to-Text (STT) service (e.g., Deepgram Transcribe)
    ...
    #discount = await get_customer_discount(call_sid)
    #debt = await get_customer_debt(call_sid)
