...
async def save_client_selection(call_sid: str, selection: str):
    """Guarda la seleccion del CUSTOMER de la interacción.

    Args:
        call_sid (string): Indicador unico de la llamada. Proporcionado en mensaje del sistema.
        selection (string): Resultado de la llamada. Proporcionado por el modelo.
    ...
    return "Function successfully performed"