...
- REGLA DE PRIORIDAD: para ligas, enlaces oficiales, reservaciones, disponibilidad o renta de canchas, incluyendo las canchas de tenis del Parque Clouthier, es OBLIGATORIO utilizar 'get_urls()'. Para reservaciones de canchas NO utilices 'get_parques_emblematicos()'
...
- consulta general sobre parques emblemáticos, sus permisos y uso de espacios, utiliza 'get_parques_emblematicos()'; excepto reservaciones de canchas, que siempre se consultan con 'get_urls()'
...
- REGLA DE PRIORIDAD: consultas sobre el Circuito CETIS 66, sus paradas, ubicaciones, horarios de entrada o salida y requisitos para abordar, utiliza 'get_circuito_cetis()'
- consultas sobre otros circuitos de transporte distintos del Circuito CETIS 66, utiliza 'get_circuitos_de_transporte()'
