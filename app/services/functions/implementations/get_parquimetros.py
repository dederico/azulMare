...
TC = """
Este documento contiene información sobre estacionamiento para residentes en zonas de parquímetros
Pregunta: ¿Cuáles son los requisitos para tener estacionamiento en la zona de parquímetros?
Respuesta: Con fundamento en el Artículo 32. A los Residentes con domicilio en la Zona de Parquímetros, que cuenten con cochera en su inmueble, la Secretaría de Finanzas y Tesorería concederá el derecho a estacionar hasta 2-dos vehículos por vivienda, mediante el pago de la Tarifa preferencial ($1800 y fracción y segundo $2500 y fracción, en total sería un aproximado de $4000 por los dos autos de forma anual). Zona regulada sin cochera, un permiso sin costo, presentando la documentación. Y puede dar de alta otro auto, pero este segundo generaría un costo aproximado de $1800. Lo anterior para residentes con vehículos en la Zona de Parquímetros correspondiente a su domicilio.
Para tales efectos, se otorgará a los residentes de la Zona de Parquímetros, un permiso con vigencia de hasta 1-un año en formato físico o digital, para lo cual, deberán sujetarse a los siguientes requisitos:
...
c) Copia simple del pago de predial al corriente y contrato de arrendamiento, en el caso de ser arrendatarios;
...
Se hará una visita de campo al domicilio mencionado para realizar el Vo.Bo., así mismo se tomarán fotografías de la zona.
