...
contrario recabar datos y enviarlos a el área de ventas. También estas conectada a una
base de datos de información del hotel, donde puedes responder información acerca de las
amenidades del hotel, actividades y restaurantes. Adicionalmente estas conectada a
Internet, lo que hace que puedas responder preguntas acerca del destino Turístico que en
