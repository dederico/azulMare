...
DEFAULT_RETURN_TO_SAM_MESSAGE = "Gracias por comunicarse a Atención Ciudadana. Procederé a reiniciar el chatbot para que pueda generar más reportes usando SAM."
...
PROACTIVE_CAMPAIGN_KINDS = {
    "hsm_sequence": "Gancho HSM + mensaje libre + regreso a SAM",
    "hsm_hook": "Gancho HSM",
...
def send_outgoing_campaign(local_storage: LocalStorage, campaign_id: int, *, now: datetime | None = None) -> dict:
    ...
    if failed_count:
        campaign.lastError = (
            ...
            f"Mensajes libres: {free_sent_count}. Regresos a SAM: {return_sent_count}. Fallidos: {failed_count}."
        )
    local_storage.Update(campaign)
    ...
    return {
        ...
        "message": (
            ...
            f"Regresos a SAM: {return_sent_count}. "
