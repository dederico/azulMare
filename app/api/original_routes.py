...
def is_widget_autogenerated_name(sender_name: str, transport: str) -> bool:
    if transport != "widget":
        return False
    ...
    if normalized_name.startswith("[chat]"):
        return True
    ...
    return any(normalized_name.startswith(prefix) for prefix in autogenerated_prefixes)
...
async def whatsapp(request: Request):
    ...
    display_customer_name = sender_name
    if is_widget_autogenerated_name(sender_name, transport):
        display_customer_name = "VISITANTE_WIDGET"
    ...
    try:
        ...
        system_prompt = system_message.format(customer_name=display_customer_name,call_sid=uid,date2=date_string,
        ...
        if display_customer_name == "VISITANTE_WIDGET":
            system_prompt += (
                "\n\nINSTRUCCIÓN ADICIONAL PARA WIDGET:\n"
