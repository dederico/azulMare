...
from .implementations.create_calendly_event import create_calendly_event
...
registered_functions = [hangup,save_client_selection,create_google_event, create_calendly_event]